...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-bg_primary p-1 text-muted-foreground',
      className,
    )}
    {...props}
  />
